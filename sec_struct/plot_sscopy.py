...
fig=matplotlib.pyplot.figure(figsize=(20,16.))
...
print xticklabels
matplotlib.pyplot.xlabel('$t$ / ns',name='helvetica-oblique',size=30)
matplotlib.pyplot.xticks(xticks,xticklabels,name='helvetica-normal',size=15)
yticklabels=['K1','C2','N3','T4','A5','T6','C7','A8','T9','Q10','R11','L12','A13','N14','F15','L16','V17','H18','S19','S20','N21','N22','F23','G24','A25','I26','L27','S28','S29','T30','N31','V32','G33','S34','N35','T36','Y37']
yticks=[0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 12.5, 13.5, 14.5, 15.5, 16.5, 17.5, 18.5, 19.5, 20.5, 21.5, 22.5, 23.5, 24.5, 25.5, 26.5, 27.5, 28.5, 29.5, 30.5, 31.5, 32.5, 33.5, 34.5, 35.5, 36.5, 37.5, 38.5]
...
matplotlib.pyplot.yticks(yticks,yticklabels,name='helvetica-bold',size=10)
